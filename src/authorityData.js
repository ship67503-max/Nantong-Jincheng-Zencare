...
const hubPageSpecs = [
  ...
  },
  {
    ...
    seoTitle: 'Pet Pad Manufacturing Capability | JCZCARE OEM Factory',
    description: 'Explore JCZCARE manufacturing capability for OEM pet pads, including automated production lines, process control, quality checks, warehouse preparation, and export support.',
    kicker: 'Manufacturing Capability',
    h1: 'Manufacturing capability for OEM pet pad supply',
    intro: 'A buyer-focused view of automated production lines, material control, quality checks, warehouse preparation, and export support.',
    image: '/images/generated-site/b2b-optimization/factory-capability-workshop.webp',
  ...
  },
  {
    ...
    image: '/images/oem/factory/factory-campus-real-aerial-20260729.png',
    gallery: [
      ['/images/oem/factory/factory-campus-real-aerial-20260729.png', 'Factory campus and production building'],
      ['/images/oem/production/factory-production-line-real-20260729.jpg', 'Automated absorbent product production line'],
      ...
      ['/images/oem/factory/factory-campus-real-aerial-20260729.png', 'Factory logistics and shipment preparation'],
    ],
  },
  {
    path: '/downloads',
