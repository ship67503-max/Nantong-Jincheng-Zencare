...
const commonGallery = {
  production: [
    ['/images/production-line-clean.png', 'Automated absorbent product converting line'],
    ['/images/lamination-detail-clean.png', 'Lamination and material-guiding detail'],
    ['/images/production-line-enhanced.png', 'Production equipment and controlled line environment'],
  ],
  warehouse: [
    ['/images/warehouse-storage-clean.png', 'Finished-product warehouse and organized storage'],
    ['/images/factory-campus.jpeg', 'Factory dispatch and logistics area'],
    ['/images/custom-care-pad-packaging-ai.png', 'Private-label packing format reference'],
  ],
  quality: [
    ['/images/quality-inspection-lab-mask.png', 'Product inspection in a laboratory setting'],
    ['/images/pet-pad-layer-protection-premium.png', 'Absorbent product layer structure'],
    ['/images/production-line-clean.png', 'In-process production control environment'],
  ],
  materials: [
    ['/images/pet-pad-layer-protection-premium.png', 'Layered absorbent product construction'],
    ['/images/custom-absorbent-paper-ai.png', 'Absorbent paper sheet product format'],
    ['/images/lamination-detail-clean.png', 'Material-guiding and lamination process'],
  ],
};
...
const factoryProfiles = [
  ...
  },
  {
    ...
    gallery: [
      ['/images/factory-campus.jpeg', 'Factory profile and operating-site reference'],
      ['/images/quality-inspection-lab-mask.png', 'Product inspection and test-evidence context'],
      ['/images/production-line-clean.png', 'Manufacturing process connected to buyer documentation'],
    ],
